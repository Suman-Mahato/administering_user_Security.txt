...
01. OS Authentication
	...
	-let's create a user named with suman
	[oracle@dba167 ~]$ su - root
	Password:
	Last login: Sat Jun 25 00:16:58 +06 2022 from 192.168.1.1 on pts/4
	
	[root@dba167 ~]# useradd -u 1301 -g oinstall -G dba,asmadmin,asmdba,oper suman
	[root@dba167 ~]# passwd suman
	...
	SQL> grant create session to ops$suman;
